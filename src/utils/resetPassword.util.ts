...
export const generateResetPasswordToken = (payload: object, RESET_PASSWORD_SECRET: string) => {
  return jwt.sign(payload, RESET_PASSWORD_SECRET, { expiresIn: '1h' });
};

export const verifyResetPasswordToken = (token: string, RESET_PASSWORD_SECRET: string) => {
